import "./dateCertificateManagement.css";
import { Link } from "react-router-dom";

function DateCertificateManagement() {
  return (
    <section className='aboutUs w-100 pb-6' id='about'>
      <div className='container'>
        <h2 className='text-center mt-5 mx-auto'>date Management</h2>
        ...
        <div
          ...
          <div className='services-section d-flex align-items-center justify-content-center  flex-wrap '>
            <Link
              ...
              <h2 className='text-center position-relative '>All dates</h2>
              <p>
            ...
            <Link
              ...
              <h2 className='text-center position-relative '>Add a date</h2>
              <p>
                You can browse several commercial pages and you can buy whatever
                you want
              </p>
...
export default DateCertificateManagement;
